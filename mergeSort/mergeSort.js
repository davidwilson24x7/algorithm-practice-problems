...
// The mergesort time complexity, I think it is O(nlogn) if I remember right.

// Compare to insertion sort, mergesort also has the pivot. 
// But mergesort is more faster is beacuse it skips checking sub array every time.